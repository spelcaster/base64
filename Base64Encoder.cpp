 ...
 */
void Base64Encoder::appendChunk(std::vector< int > chunk) {
 ...
 */
std::string Base64Encoder::encodeChunks(
 ...
 * @returns The resultant string
 */
std::string Base64Encoder::encodeChunk(
    ...
    str += getCharacterAt(conv.getDecimal());
 ...
 */
std::string Base64Encoder::encode(std::string text) {
